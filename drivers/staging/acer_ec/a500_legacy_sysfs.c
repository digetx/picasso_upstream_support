...
static EC_ATTR(GyroGain, 0666, gyro_show, gyro_store);
static EC_ATTR(PowerLED, 0222, NULL, pwr_led_on_store);
static EC_ATTR(ChargeLED, 0222, NULL, chrg_led_on_store);
static EC_ATTR(OriSts, 0222, NULL, reset_led_store);
static EC_ATTR(OffLED, 0222, NULL, leds_off_store);
static EC_ATTR(LEDAndroidOff, 0222, NULL, android_off_store);
static EC_ATTR(AutoLSGain, 0666, ls_gain_show, ls_gain_store);
static EC_ATTR(BTMAC, 0666, btmac_show, btmac_store);
static EC_ATTR(WIFIMAC, 0666, wifimac_show, wifimac_store);
static EC_ATTR(DeviceStatus, 0666, device_status_show, device_status_store);
static EC_ATTR(ThreeGPower, 0666, status_3g_show, status_3g_store);
static EC_ATTR(GPSPower, 0666, status_gps_show, status_gps_store);
static EC_ATTR(Cabc, 0666, cabc_show, cabc_store);
static EC_ATTR(SystemConfig, 0666, sysconf_show, sysconf_store);
static EC_ATTR(MicSwitch, 0666, audioconf_show, audioconf_store);
